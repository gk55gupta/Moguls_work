...
background: linear-gradient(to right, #185a9d, #43cea2);" id="start" data-slidescroll-title-selector="h1">
                    ...
                    <div class="fir">
                        ...
                        <div class="col-md-12 teet">
                            ...
                            <p class="srll wow fadeInUp" data-wow-duration="1s" data-wow-delay="3s"><a href="#third"><img class="scrl" src="http://www.symodd.com/img/scroll-down.png" /></a></p>
                            <br/>
                            <div class="col-md-12">
...
--></div>
                        ...
                        <p class="srll"><a href="#third"><img class="scrl" src="http://www.symodd.com/img/scroll-down.png" /></a></p>
                        <br/> </div>
                </div>
...
--></div>
                        ...
                        <p class="srll"><a href="#fifth"><img src="http://www.symodd.com/img/scroll-down.png"  class="scrl"/></a></p>
                        <br/> </div>
                </div>
...
--></div>
                        ...
                        <p class="srll"><a href="#sixth"><img src="http://www.symodd.com/img/scroll-down.png" class="scrl"/></a></p>
                        <br/> </div>
                </div>
            ...
            <div class="bottom-row">
                <div class="">
                    <div class="">
                        ...
                        <div class="offset-md-4 col-md-5 contacts">
...
.sc-icons {
   float: right;z-index: 99999999999;position: inherit;margin-right:25px;
}
